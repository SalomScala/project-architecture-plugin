...
public class ForbidRule implements Rule {
	...
	public String toString() {
		...
		if (!this.edges.isEmpty()) {
			...
			builder.append(
					"      " + this.edges.stream().map((final Dependency p) -> p.getFrom() + "-/->" + p.getTo())
					.reduce((a, b) -> a + "\r\n      " + b).orElse(""));
		}
	...
	public static void forbid(final Dimension firstDim, final Dimension secondDim, final Set<Dependency> forbiddenEdges) {
